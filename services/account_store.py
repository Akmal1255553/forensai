"""Аккаунты, подписки и реферальная программа (локальное хранилище)."""
...
from config import DATA_DIR, FREE_ANALYSES_PER_MONTH, REFERRAL_DISCOUNT_PERCENT

ACCOUNTS_FILE = DATA_DIR / "accounts.json"

PLANS = {
    "free": {"analyses_limit": FREE_ANALYSES_PER_MONTH, "price_usd": 0},
    "pro": {"analyses_limit": 999_999, "price_usd": 9.99},
}
...
def upgrade_plan(user_id: str, plan: str = "pro") -> dict:
    ...
    user["plan"] = plan
    if plan == "pro":
        user["plan_expires_at"] = None  # демо: бессрочно после «оплаты»
