...
(function () {
  ...
  const messages = {
    ru: {
      ...
      "osint.copy": "Копировать",
      "osint.copied": "Хеш скопирован",
      "osint.exifDetails": "EXIF подробнее",
      "osint.exifMissingShort": "EXIF: нет",
      "osint.exifPresentShort": "EXIF: есть",
      "osint.exifErrorShort": "EXIF: ошибка",
      "osint.exifCamera": "📷 {model}",
      "osint.durationShort": "{n} с",
    ...
    en: {
      ...
      "osint.copy": "Copy",
      "osint.copied": "Hash copied",
      "osint.exifDetails": "EXIF details",
      "osint.exifMissingShort": "EXIF: none",
      "osint.exifPresentShort": "EXIF: yes",
      "osint.exifErrorShort": "EXIF: error",
      "osint.exifCamera": "📷 {model}",
      "osint.durationShort": "{n}s",
    ...
    uz: {
      ...
      "osint.copy": "Nusxa",
      "osint.copied": "Xesh nusxalandi",
      "osint.exifDetails": "EXIF batafsil",
      "osint.exifMissingShort": "EXIF: yo‘q",
      "osint.exifPresentShort": "EXIF: bor",
      "osint.exifErrorShort": "EXIF: xato",
      "osint.exifCamera": "📷 {model}",
      "osint.durationShort": "{n} s",
